...
Inside a thread almost nothing is boxed, and nothing stands there waiting to be
used — the actions live in the hold, so a comment is a name, a line, and
sometimes a reaction. An outline around every count, every key and every tag turned a
