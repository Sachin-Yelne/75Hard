...
- The chip is updated in place rather than re-rendered. Replacing the node restarts its transition from nothing, which on a control that shows and hides twice a scroll is a fade that never fades.
